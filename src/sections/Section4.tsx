...
const SECTION4_TEXTS: SectionTextProps[] = [
  ...
  {
    body: `In the late 1950s, amid political struggles within the Party, the errors of the "[[Great Leap Forward|An economic campaign (1958–1960) aimed at rapid industrialization and agricultural collectivization. Unrealistic targets and exaggerated reporting led to severe economic difficulties.]]"\n and the "[[Anti-Rightist Deviation|A political campaign (1959) against "right opportunism" that interrupted efforts to correct existing leftist errors in economic terms, allowing those mistakes to persist for a longer period.]]" campaign laid the groundwork for\nexaggerated agricultural production claims. From 1959 to 1961, [[the Three Years of Natural Disasters|Refers to a period of hardship experienced by China from 1959 to 1961. During this time, the country was affected by consecutive natural disasters such as droughts and floods, and suffered from severe food shortages and economic difficulties.]]\ncombined with the Soviet government's perfidious tearing up of contracts,\ncaused severe difficulties in China's national economy, inflicting major losses on the\ncountry and its people.`,
    style: {
      left: '140vw',
      top: '10% ',
    },
